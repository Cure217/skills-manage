...
description: 提取 B站视频的公开元数据、章节点与字幕可用性，并生成中文摘要、时间轴笔记、要点总结或公众号风格的详细改写版。也支持导出公开视频字幕，或对用户提供的本地音视频做完整转写。适用于用户要快速了解某个 B站视频讲了什么、是否有公开字幕、适不适合继续看，或整理自己的本地视频字幕稿时。
---
...
如果用户明确要“文档版 / 公众号版 / 长文改写版”：

- 可以输出一版详细改写稿
- 改写稿应保持结构完整、可读性强、适合直接阅读
- 如果没有公开字幕，必须明确说明“该稿件基于标题、简介、章节点与公开元数据整理，不是逐字稿”
- 不要声称“95% 还原原视频”或“基本等同逐字稿”
...
- 允许输出“详细改写版 / 公众号整理版”，但不能把它包装成完整逐字稿
- 不要承诺“95% 以上内容完整度”这类接近全文复原的表述
